...
int main() {
    typedef Number NumberClass; // zastąp XYZ nazwą klasy `Number`
    std::string (NumberClass::*toStringPtr)() = &Number::toString; // zastąp xyzToString nazwą metody `toString`
    // konieczne może być dodanie `const` przed znakiem =
